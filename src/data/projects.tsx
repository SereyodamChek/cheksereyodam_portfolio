...
const PROJECT_SKILLS = {
  ...
  photoshop: {
    ...
    bg: "black",
    fg: "white",
    icon: <img src="assets/icons/ps.svg" alt="Photoshop" />,
  },
  illustrator: {
    title: "Illustrator",
    bg: "black",
    fg: "white",
    icon: <img src="assets/icons/ai.svg" alt="Illustrator" />,
  },
};
export type Project = {
  id: string;
...
const projects: Project[] = [
  ...
  // +
  {
    ...
    id: "Exchange Program in China",
    category: "Exchange Program in China",
    title: "Artificial Intelligence ",
    src: "/assets/projects-screenshots/aidockerfileoptimizer/2.png",
    screenshots: ["1.png", "2.png", "3.png"],
    live: "https://sereyodamchek.xzy",
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            Exchange Program in China from 1 July 2025 to 25 July 2025 at Guilin
            University of Electronic Technology (GUET). This program offers a
            unique opportunity to immerse oneself in Chinese culture, enhance
            language skills, and gain a global perspective through academic and
  ...
  },
  {
    ...
    id: "ABA BANK",
    category: "ABA BANK",
    title: "ABA BANK System",
    src: "/assets/projects-screenshots/financeme/2.png",
    screenshots: ["/assets/projects-screenshots/financeme/2.png"],
    skills: {
      frontend: [PROJECT_SKILLS.next, PROJECT_SKILLS.tailwind],
      backend: [PROJECT_SKILLS.openai],
    },
    live: "https://sereyodamchek.xzy",
    github: "https://sereyodamchek.xzy",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            ABA BANK System HRMIS
          </TypographyP>
          <TypographyP className="font-mono ">
            This is a HRMIS system designed for ABA BANK System to manage
            employee information, attendance, payroll, and performance
            evaluations. The system aims to streamline HR processes, improve
            data accuracy, and enhance overall efficiency in managing human
            resources within the organization.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8">Architecture </TypographyH3>
          <p className="font-mono mb-2">
            The project is design for Human Resource Management Information
            System (HRMIS) for ABA BANK System. The system is built using Java
            Spring Boot for the backend, PostgreSQL for the database, and
            HTML/CSS/JavaScript with Bootstrap for the frontend. The
            architecture follows a multi-tier design, separating concerns
            between the presentation layer, business logic layer, and data
            access layer.
          </p>
          <SlideShow
            images={[
  ...
  },
  {
    ...
    live: "https://www.sereyodamchek.xzy",
    github: "https://github.com/SereyodamChek/",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
  ...
  },
  {
    ...
    id: "Poster for ABA BANK",
    category: "Adobe Photoshop",
    title: "Poster for ABA BANK",
    src: "/assets/projects-screenshots/smartparkingassitant/aba.jpg",
    screenshots: [
      "aba.jpg",
      "EVA-Air.jpg",
      "Untitled-1.jpg",
      ...
      "Aba2.jpg",
      "ABA-King.jpg",
      "ABA-VishakaBojea.jpg",
      "Dom-1.jpg",
    ],
    live: "https://github.com/SereyodamChek/",
    github: "https://github.com/SereyodamChek/",
    skills: {
      frontend: [PROJECT_SKILLS.photoshop, PROJECT_SKILLS.illustrator],
      backend: [],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            I used to design a poster for ABA BANK to promote their new banking
            services and products. The poster was designed to be visually
            appealing and informative, highlighting the key features and
            benefits of the banks offerings. I utilized graphic design software
            such as Adobe Photoshop and Illustrator to create the poster,
            incorporating the bank branding elements and color scheme. The
            final design was well-received by the bank and effectively
            communicated their message to potential customers.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/smartparkingassitant/aba.jpg`,
              `${BASE_PATH}/smartparkingassitant/EVA-Air.jpg`,
              `${BASE_PATH}/smartparkingassitant/Untitled-1.jpg`,
              `${BASE_PATH}/smartparkingassitant/new-theme1.jpg`,
              `${BASE_PATH}/smartparkingassitant/Aba2.jpg`,
              `${BASE_PATH}/smartparkingassitant/ABA-King.jpg`,
              `${BASE_PATH}/smartparkingassitant/ABA-VishakaBojea.jpg`,
              `${BASE_PATH}/smartparkingassitant/Dom-1.jpg`,
            ]}
          />
        </div>
      );
  ...
  {
    // 05. all my certificates project
    id: "All my Certificates",
    category: "Certificates",
    title: "All my Certificates",
    src: "/assets/projects-screenshots/smartjobtracker/008.png",
    screenshots: [
      "001.png",
      "002.png",
      "003.png",
    ...
    skills: {
      ...
      backend: [PROJECT_SKILLS.firebase, PROJECT_SKILLS.netlify],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            This is all my certificates that I have completed from various
            platforms such as Coursera, Udemy, edX, and others. These
            certificates showcase my skills and knowledge in different areas
            such as web development, data science, machine learning, and more.
            Each certificate represents a milestone in my learning journey and
            reflects my commitment to continuous improvement and professional
            growth.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/smartjobtracker/001.png`,
              `${BASE_PATH}/smartjobtracker/002.png`,
              `${BASE_PATH}/smartjobtracker/003.png`,
              `${BASE_PATH}/smartjobtracker/004.png`,
              `${BASE_PATH}/smartjobtracker/005.png`,
              `${BASE_PATH}/smartjobtracker/006.png`,
              `${BASE_PATH}/smartjobtracker/007.png`,
              `${BASE_PATH}/smartjobtracker/008.png`,
            ]}
          />
        </div>
      );
  ...
  {
    // 06. Sereyodam Chek portfolio project
    id: "Sereyodam Chek Portfolio",
    category: "Web Development",
    title: "Sereyodam Chek Portfolio",
    src: "/assets/projects-screenshots/smartjobtracker/009.png",
    screenshots: ["1.png", "2.png", "3.png", "4.png", "5.png"],
    live: "https:sereyodamchek.xzy",
    github: "https://github.com/SereyodamChek/",
    skills: {
      ...
      return (
        <div>
          <TypographyP className="font-mono ">
            ...
            a mentor who transforms lives. 💻🕊️ Crafted with ❤️ by Sereyodam
            Chek ❤️
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
